...
export default async function Home() {
  ...
  if (skills.length === 0) {
    skills = [
      { id: 1, name: "Flutter", icon: "Smartphone", order: 0 },
      { id: 2, name: "React Native", icon: "Code", order: 1 },
      { id: 3, name: "iOS Development", icon: "Smartphone", order: 2 },
    ];
  }
      ...
      <section id="skills" className="py-24 bg-black/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative w-14 h-14 bg-gradient-to-br from-primary/20 to-primary/5 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      {IconComponent && <IconComponent className="w-7 h-7 text-primary group-hover:text-primary transition-colors" />}
                    </div>
            ...
            {/* CV Download */}
            <div className="mt-16">
              <button className="px-10 py-4 rounded-full bg-gradient-to-r from-primary to-primary/80 text-black font-bold hover:shadow-[0_0_40px_rgba(204,255,0,0.4)] transition-all duration-300 text-lg uppercase tracking-wider">
