...
export const ENTERPRISE_KEYWORDS = ['doulado', 'sefere', 'hababond', 'hababbond', 'hababondlite', 'hababbondlite'];
...
export async function getMergedProjects() {
  ...
  dbProjects.forEach(p => {
    ...
    if (uniqueProjectsMap.has(title)) {
      ...
      uniqueProjectsMap.set(title, { ...p, isEnterprise });
    }
  });
