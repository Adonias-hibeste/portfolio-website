...
export const showcaseProjects = [
  ...
  },
  {
    ...
    problem: "General dating apps lack the localized matching algorithms, cultural security checks, and high-fidelity video features requested by the Ethiopian community globally.",
  ...
  },
  {
    ...
    problem: "Diaspora communities needed a centralized platform combining social media feeds with a localized marketplace, which requires high-performance list rendering and secure item chat.",
